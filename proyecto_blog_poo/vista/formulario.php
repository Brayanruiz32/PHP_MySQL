...
<body>
	<!--  <div id="cajita" style="border: 1px dashed black;">-->
		<form action="controlador/titulos_controlador.php" method="post" enctype="multipart/form-data">
			<table>
				<tr>
					<td>Titulo:</td>
				...
				<tr>
					<td colspan="2" style="text-align: center;"><a href="controlador/titulos_controlador.php">Pagina de visualizacion del blog</a></td>
				</tr>
			</table>
		</form>
	<!-- </div>-->
